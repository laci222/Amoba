...
class Widgets { // grafikus vezérlõ õsosztálya
    protected:
        int x, y, size_x, size_y;
        bool inFocus;

    public:
        Widgets( );                                                  // Default konstruktor (csak létrehozza az egyedet)
        Widgets( int _x, int _y, int _size_x, int _size_y );         // A konstruktor inicializálja a widget paramétereit
